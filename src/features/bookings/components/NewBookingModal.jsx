...
import { X, Calendar, Clock, User, DollarSign, Bell, MapPin } from 'lucide-react';

// Mock data para clientes y terapias
const mockClients = [
  { id: 'CL001', name: 'María García', email: 'maria.garcia@email.com', phone: '+34 666 123 456' },
  { id: 'CL002', name: 'Carlos Rodríguez', email: 'carlos.rodriguez@email.com', phone: '+34 666 789 012' },
  { id: 'CL003', name: 'Ana López', email: 'ana.lopez@email.com', phone: '+34 666 345 678' },
  { id: 'CL004', name: 'Pedro Martín', email: 'pedro.martin@email.com', phone: '+34 666 901 234' },
  { id: 'CL005', name: 'Laura Fernández', email: 'laura.fernandez@email.com', phone: '+34 666 567 890' }
];
...
export const NewBookingModal = ({ isOpen, onClose, onConfirm, availableSlots = {}, isLoading = false }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const bookingData = {
        ...
        endTime: calculateEndTime(formData.startTime, selectedTherapy?.duration || 60),
            ...
            <div className="w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  {errors.therapyId && (
                    <p className="mt-1 text-sm text-red-600">{errors.therapyId}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {(availableTimesForDate.length > 0 ? availableTimesForDate : timeSlots).map(time => (
                ...
                {/* Resumen */}
                {selectedClient && selectedTherapy && formData.date && formData.startTime && (
                  <div className="bg-blue-50 p-4 rounded-md">
                    ...
                    <div className="text-sm text-blue-800 space-y-1">
                      ...
                      <p><strong>Terapia:</strong> {selectedTherapy.name} ({selectedTherapy.duration} min)</p>
                      ...
                      <p><strong>Hora:</strong> {formData.startTime} - {calculateEndTime(formData.startTime, selectedTherapy.duration)}</p>
