...
export const PublicPreviewModal = ({ isOpen, onClose, profileData }) => {
  ...
  // Simular datos adicionales para la vista pública
  const mockData = {
    rating: 4.8,
    reviewCount: 127,
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 mt-2 text-sm text-gray-600">
                    <div className="flex items-center space-x-1">
                      ...
                      <span>({mockData.reviewCount} reseñas)</span>
                    </div>
                    <div className="flex items-center space-x-1">
                  ...
                  <div className="flex items-center space-x-4 mt-2 text-sm text-gray-600">
                    ...
                    <div>
                      <span>{mockData.completedSessions} sesiones completadas</span>
                    </div>
                  </div>
                </div>
              </div>
