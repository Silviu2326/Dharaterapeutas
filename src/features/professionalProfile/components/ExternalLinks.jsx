...
const ExternalLinks = ({ links = [], onChange, isEditing }) => {
  ...
  const linkTypes = [
    { value: 'website', label: 'Página Web', icon: '🌐', placeholder: 'https://mipaginaweb.com' },
    { value: 'blog', label: 'Blog', icon: '📝', placeholder: 'https://miblog.com' },
    { value: 'linkedin', label: 'LinkedIn', icon: '💼', placeholder: 'https://linkedin.com/in/usuario' },
    { value: 'instagram', label: 'Instagram', icon: '📷', placeholder: 'https://instagram.com/usuario' },
    { value: 'facebook', label: 'Facebook', icon: '📘', placeholder: 'https://facebook.com/usuario' },
    { value: 'twitter', label: 'Twitter/X', icon: '🐦', placeholder: 'https://twitter.com/usuario' },
    { value: 'youtube', label: 'YouTube', icon: '📺', placeholder: 'https://youtube.com/c/usuario' },
    { value: 'tiktok', label: 'TikTok', icon: '🎵', placeholder: 'https://tiktok.com/@usuario' },
    { value: 'other', label: 'Otro', icon: '🔗', placeholder: 'https://ejemplo.com' }
  ];
